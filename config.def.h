...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbordercolor, "-sf", selfgcolor, "-h", "23", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_a,		zoom,           {0} },
	{ MODKEY|Mod1Mask,              XK_plus,      incrgaps,       {.i = +1 } },
	...
	{ MODKEY|Mod1Mask,              XK_j,      incrovgaps,     {.i = +1 } },
	{ MODKEY|Mod1Mask|ShiftMask,    XK_k,      incrovgaps,     {.i = -1 } },
